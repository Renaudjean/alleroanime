    ...
    if($searchResults != ''){
     foreach($searchResults as $searchResult){
      ...
      if($searchResult->media_type == "tv" && in_array("16", $searchResult->genre_ids)){?>
        ...
        <a href="../../Info/infoMovies/<?= $searchResult->id;?>" class="cover-photo cat-photo"><img class="cat-photo" src="https://image.tmdb.org/t/p/w200/<?=$searchResult->poster_path?>"></a>
        </div>
        </div>
        <?php }
        ...
        <a href="../../Info/infoSeries/<?= $searchResult->id;?> " class="cover-photo cat-photo"><img class="cat-photo" src="https://image.tmdb.org/t/p/w200/<?=$searchResult->poster_path?>"></a>
        </div>
       </div>
       <?php  }
           }
          ...
          if($GenreID !=''){
            foreach($SerieGenres as $SerieGenre){
              ...
              <div class='counter'>
                ...
                <a href="../../Info/infoSeries/<?= $SerieGenre->id;?>" class="cover-photo cat-photo"><img class="cat-photo" src="https://image.tmdb.org/t/p/w200/<?=$SerieGenre->poster_path?> "></a>
                </div>
                </div>
              ...
              <div class='counter'>
                <div class='cat-cards'>
                  ...
                  <a href="../../Info/infoMovies/<?= $MovieGenre->id;?>" class="cover-photo cat-photo"><img class="cat-photo" src="https://image.tmdb.org/t/p/w200/<?=$MovieGenre->poster_path?>"></a>
                  </div>
                  </div>
                <?php  }else{
                  break;
